...
# Apply one cantilever only //10AUG YZ
...
def get_complex_signals(measurement): #keep z0 only, remove z1 //10AUG YZ
    """
...
def calculate_complex_ratio(measurement):
    ...
    z0 = get_complex_signals(measurement)

    return z0 #/ z1 //10AUG YZ
